...
$url = "https://forums.pokemmo.com/index.php?/topic/179868-brilliant-doves-shiny-ot-showcase/";
...
// Exclusion list for usernames
$exclusionList = ["Total shiny pokemon recorded: 141"];
...
foreach ($pTags as $pTag) {
    ...
    if (preg_match($usernamePattern, $pContent, $usernameMatches)) {
        ...
        if (!in_array($username, $exclusionList) && $imageCount > 0) {
...
// Display the results
echo "<h1>Team DOVE OT Shiny Showcase</h1>";
echo "<ul>";
foreach ($users as $username => $data) {
